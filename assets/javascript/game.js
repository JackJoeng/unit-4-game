characters = [
{
  ...
  "damage"  : 12,
  "dmgInc"  : 12,
  "avatar"  : "./assets/images/card-hp.jpg"
},
{
  "id"      : 1,
  "name"    : "Golduck",
  ...
  "damage"  : 10,
  "dmgInc"  : 8,
  "avatar"  : "./assets/images/card-ss.jpg"
},
{
  "id"      : 2,
  "name"    : "Blastoise",
  ...
  "damage"  : 11,
  "dmgInc"  : 8,
  "avatar"  : "./assets/images/card-bl.jpg"
},
{
  "id"      : 3,
  "name"    : "Pikachu",
  ...
  "damage"  : 18,
  "dmgInc"  : 5,
  "avatar"  : "./assets/images/card-v.jpg"
}
];
...
function renderCards(){
  for(var i=0; i < characters.length; i++) {
    ...
    var hp = "<h4 class='hp'>"+characters[i].hp+" Health Points</h4>";
    card.addClass("card");
    card.attr("id", i);
    card.html(name);
    card.append(avatar);
...
function attack() {
  if(state === "attack") {
    ...
    $("#arena #status").append(opponent.name +" attacked you back for "+opponent.damage+" damage.");
